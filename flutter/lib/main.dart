...
void main() async {
  ...
  await Supabase.initialize(
    url: 'https://tpqwbnfgckvqkbewfzzw.supabase.co',
    anonKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRwcXdibmZnY2t2cWtiZXdmenp3Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDgzODMxNTYsImV4cCI6MjA2Mzk1OTE1Nn0.ueo-zKq_sGaLMB7Cv3naf2GMUIDexXiFQH_WM9CcYSA',
  );
...
class RideQMainScreen extends StatefulWidget {
  const RideQMainScreen({super.key});

  @override
  RideQMainScreenState createState() => RideQMainScreenState();
}

class RideQMainScreenState extends State<RideQMainScreen> {
